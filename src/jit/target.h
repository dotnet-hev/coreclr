...
#define TARGET_READABLE_NAME "MIPS64"
#else
...
#ifdef FEATURE_SIMD
#pragma error("SIMD Unimplemented yet MIPS")
  #define ALIGN_SIMD_TYPES         1       // whether SIMD type locals are to be aligned
  #define FEATURE_PARTIAL_SIMD_CALLEE_SAVE 1 // Whether SIMD registers are partially saved at calls
#endif // FEATURE_SIMD
...
/* FIXME for MIPS */
  ...
  #define MAX_ARG_REG_COUNT             8  // Maximum registers used to pass a single argument in multiple registers.
  #define MAX_RET_REG_COUNT             2  // Maximum registers used to return a value.
...
/* FIXME for MIPS */
  #define REG_FP_FIRST             REG_F0
  #define REG_FP_LAST              REG_F31
  #define FIRST_FP_ARGREG          REG_F12
  #define LAST_FP_ARGREG           REG_F19

  #define REGNUM_BITS              6       // number of bits in a REG_* within registermips64.h
  #define REGSIZE_BYTES            8       // number of bytes in one general purpose register
  ...
  #define RBM_INT_CALLEE_SAVED    (RBM_S0|RBM_S1|RBM_S2|RBM_S3|RBM_S4|RBM_S5|RBM_S6|RBM_S7)
  #define RBM_INT_CALLEE_TRASH    (RBM_V0|RBM_V1|RBM_A0|RBM_A1|RBM_A2|RBM_A3|RBM_A4|RBM_A5|RBM_A6|RBM_A7|RBM_T0|RBM_T1|RBM_T2|RBM_T3|RBM_T8|RBM_T9)
  #define RBM_FLT_CALLEE_SAVED    (RBM_F24|RBM_F25|RBM_F26|RBM_F27|RBM_F28|RBM_F29|RBM_F30|RBM_F31)
  #define RBM_FLT_CALLEE_TRASH    (RBM_F0|RBM_F2|RBM_F3|RBM_F4|RBM_F5|RBM_F6|RBM_F7|RBM_F8|RBM_F9|RBM_F10|RBM_F12|RBM_F13|RBM_F14|RBM_F15|RBM_F16|RBM_F17|RBM_F18|RBM_F19|RBM_F20|RBM_F21|RBM_F22|RBM_F23)

  #define RBM_CALLEE_SAVED        (RBM_INT_CALLEE_SAVED | RBM_FLT_CALLEE_SAVED)
  #define RBM_CALLEE_TRASH        (RBM_INT_CALLEE_TRASH | RBM_FLT_CALLEE_TRASH)

/* FIXME for MIPS */
  #define REG_DEFAULT_HELPER_CALL_TARGET REG_T9
  #define RBM_DEFAULT_HELPER_CALL_TARGET RBM_T9

/* FIXME for MIPS */
  #define REG_FASTTAILCALL_TARGET REG_T9   // Target register for fast tail call
  #define RBM_FASTTAILCALL_TARGET RBM_T9
  ...
  #define REG_VAR_ORDER            REG_A0,REG_A1,REG_A2,REG_A3,REG_A4,REG_A5,REG_A6,REG_A7, \
                                   REG_V0,REG_V1,REG_T0,REG_T1,REG_T2,REG_T3,REG_T8,REG_T9, \
                                   REG_CALLEE_SAVED_ORDER

  /* FIXME for MIPS: should confirm! */
  #define REG_VAR_ORDER_FLT        REG_F12,REG_F13,REG_F14,REG_F15,REG_F16,REG_F17,REG_F18,REG_F19, \
                                   REG_F3,REG_F4,REG_F5,REG_F6,REG_F7,REG_F8,REG_F9,REG_F10, \
                                   REG_F20,REG_F21,REG_F22,REG_F23, \
                                   REG_F24,REG_F25,REG_F26,REG_F27,REG_F28,REG_F29,REG_F30,REG_F31, \
                                   REG_F0,REG_F2

  #define REG_CALLEE_SAVED_ORDER   REG_S0,REG_S1,REG_S2,REG_S3,REG_S4,REG_S5,REG_S6,REG_S7
  #define RBM_CALLEE_SAVED_ORDER   RBM_S0,RBM_S1,RBM_S2,RBM_S3,RBM_S4,RBM_S5,RBM_S6,RBM_S7

  #define CNT_CALLEE_SAVED        (8)             //s0-s7, not including gp,fp,ra.
  #define CNT_CALLEE_TRASH        (16)
  #define CNT_CALLEE_ENREG        (CNT_CALLEE_SAVED-1)

  #define CNT_CALLEE_SAVED_FLOAT  (8)
  #define CNT_CALLEE_TRASH_FLOAT  (23)
  ...
  // register to hold shift amount; no special register is required on MIPS64.
  #define REG_SHIFT                REG_NA
  #define RBM_SHIFT                RBM_ALLINT
  ...
  #define REG_JUMP_THUNK_PARAM     REG_T9
  #define RBM_JUMP_THUNK_PARAM     RBM_T9

  // MIPS64 write barrier ABI (see vm/mips64/asmhelpers.S):
  // CORINFO_HELP_ASSIGN_REF (JIT_WriteBarrier), CORINFO_HELP_CHECKED_ASSIGN_REF (JIT_CheckedWriteBarrier):
  //     On entry:
  ...
  #define REG_WRITE_BARRIER_DST          REG_V0
  #define RBM_WRITE_BARRIER_DST          RBM_V0

  #define REG_WRITE_BARRIER_SRC          REG_V1
  #define RBM_WRITE_BARRIER_SRC          RBM_V1

  #define REG_WRITE_BARRIER_DST_BYREF    REG_V0
  #define RBM_WRITE_BARRIER_DST_BYREF    RBM_V0

  #define REG_WRITE_BARRIER_SRC_BYREF    REG_T8
  #define RBM_WRITE_BARRIER_SRC_BYREF    RBM_T8

  #define RBM_CALLEE_TRASH_NOGC          (RBM_WRITE_BARRIER_SRC|RBM_T0|RBM_T1|RBM_T2|RBM_T3|RBM_DEFAULT_HELPER_CALL_TARGET)
  ...
  #define REG_INDIRECT_CALL_TARGET_REG    REG_T9
  ...
  #define REG_FIRST                REG_R0
  #define REG_INT_FIRST            REG_R0
  #define REG_INT_LAST             REG_RA
  #define REG_INT_COUNT            (REG_INT_LAST - REG_INT_FIRST + 1)
  #define REG_NEXT(reg)           ((regNumber)((unsigned)(reg) + 1))
  #define REG_PREV(reg)           ((regNumber)((unsigned)(reg) - 1))

  // The following registers are used in emitting Enter/Leave/Tailcall profiler callbacks
  #define REG_PROFILER_ENTER_ARG           REG_S0
  #define RBM_PROFILER_ENTER_ARG           RBM_S0
  #define REG_PROFILER_RET_SCRATCH         REG_S2
  #define RBM_PROFILER_RET_SCRATCH         RBM_S2
  #define RBM_PROFILER_RET_USED            (RBM_S0 | RBM_S1 | RBM_S2)
  #define REG_PROFILER_JMP_ARG             REG_S0
  #define RBM_PROFILER_JMP_USED            RBM_S0
  #define RBM_PROFILER_TAIL_USED           (RBM_S0 | RBM_S2 | RBM_RA)


  // Which register are int and long values returned in ?
  ////FIXME for MIPS.
  #define REG_INTRET               REG_V0
  #define RBM_INTRET               RBM_V0
  #define REG_LNGRET               REG_V0
  #define RBM_LNGRET               RBM_V0
  // second return register for 16-byte structs
  #define REG_INTRET_1             REG_V1
  #define RBM_INTRET_1             RBM_V1
  ...
  #define REG_ARG_FP_FIRST         REG_F12
  #define REG_ARG_FP_LAST          REG_F19
  #define INIT_ARG_STACK_SLOT      0                  // No outgoing reserved stack slots
  ...
  SELECTANY const regNumber intArgRegs [] = {REG_A0, REG_A1, REG_A2, REG_A3, REG_A4, REG_A5, REG_A6, REG_A7};
  SELECTANY const regMaskTP intArgMasks[] = {RBM_A0, RBM_A1, RBM_A2, RBM_A3, RBM_A4, RBM_A5, RBM_A6, RBM_A7};
  ...
  #define REG_FLTARG_0             REG_F12
  #define REG_FLTARG_1             REG_F13
  #define REG_FLTARG_2             REG_F14
  #define REG_FLTARG_3             REG_F15
  #define REG_FLTARG_4             REG_F16
  #define REG_FLTARG_5             REG_F17
  #define REG_FLTARG_6             REG_F18
  #define REG_FLTARG_7             REG_F19

  #define RBM_FLTARG_0             RBM_F12
  #define RBM_FLTARG_1             RBM_F13
  #define RBM_FLTARG_2             RBM_F14
  #define RBM_FLTARG_3             RBM_F15
  #define RBM_FLTARG_4             RBM_F16
  #define RBM_FLTARG_5             RBM_F17
  #define RBM_FLTARG_6             RBM_F18
  #define RBM_FLTARG_7             RBM_F19

  #define RBM_ARG_REGS            (RBM_ARG_0|RBM_ARG_1|RBM_ARG_2|RBM_ARG_3|RBM_ARG_4|RBM_ARG_5|RBM_ARG_6|RBM_ARG_7)
  #define RBM_FLTARG_REGS         (RBM_FLTARG_0|RBM_FLTARG_1|RBM_FLTARG_2|RBM_FLTARG_3|RBM_FLTARG_4|RBM_FLTARG_5|RBM_FLTARG_6|RBM_FLTARG_7)

  SELECTANY const regNumber fltArgRegs [] = {REG_F12, REG_F13, REG_F14, REG_F15, REG_F16, REG_F17, REG_F18, REG_F19 };
  SELECTANY const regMaskTP fltArgMasks[] = {RBM_F12, RBM_F13, RBM_F14, RBM_F15, RBM_F16, RBM_F17, RBM_F18, RBM_F19 };

  #define B_DIST_SMALL_MAX_NEG  (-131072)
  #define B_DIST_SMALL_MAX_POS  (+131071)

  #define OFFSET_DIST_SMALL_MAX_NEG   (-32768)
  #define OFFSET_DIST_SMALL_MAX_POS   (+32767)
...
inline regMaskTP genRegMaskFloat(regNumber reg, var_types type /* = TYP_DOUBLE */)
{
#if defined(_TARGET_AMD64_) || defined(_TARGET_ARM64_) || defined(_TARGET_X86_) || defined(_TARGET_MIPS64_)
    assert(genIsValidFloatReg(reg));
    assert((unsigned)reg < ArrLen(regMasks));
    return regMasks[reg];
#elif defined(_TARGET_ARM_)
