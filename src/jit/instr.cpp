 ...
 *
 *  NOTE-mips: no branch-delay!!!  delay-slot will be generated with jump together.
 */
...
#elif defined(_TARGET_MIPS64_)
    // TODO: Use the exact barrier type (runtime detection required)
    getEmitter()->emitIns_I(INS_sync, EA_4BYTE, INS_BARRIER_FULL);
#else
#error "Unknown _TARGET_"
#endif
}
