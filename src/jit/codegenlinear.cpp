...
void CodeGen::genSpillVar(GenTree* tree)
{
    ...
    if (needsSpill)
    {
        // We need this after "GetRegNum()" has change because now we are sure that varDsc->lvIsInReg() is false.
...
// TODO-Cleanup: The following code could probably be further merged and cleaned up.
            ...
            // factored because it, in turn, updates GetMaskVars() which is part of RegSet not GCInfo.
...
regNumber CodeGen::genConsumeReg(GenTree* tree)
{
    ...
    // the GetRegNum() will be set to REG_STK and we will lose track of what register currently holds
