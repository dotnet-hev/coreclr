...
void emitIns_J_cond_mips(instruction ins, BasicBlock* dst, regNumber reg1 = REG_R0, regNumber reg2 = REG_R0);
void emitIns_I_mips(emitAttr attr, regNumber reg, ssize_t imm);
